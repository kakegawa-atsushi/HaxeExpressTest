...
App.main = function() {
	...
	var indexRoute = new routes.IndexRoute();
	var dataRoute = new routes.DataRoute();
	var path = js.Node.path;
	var app = express();
	...
	app.get("/",$bind(indexRoute,indexRoute.index));
	app.get("/data",$bind(dataRoute,dataRoute.data));
...
var routes = {}
routes.DataRoute = function() {
};
routes.DataRoute.__name__ = true;
routes.DataRoute.prototype = {
	data: function(req,res) {
		res.write("test");
		res.end();
	}
	,__class__: routes.DataRoute
}
routes.IndexRoute = function() {
};
routes.IndexRoute.__name__ = true;
routes.IndexRoute.prototype = {
	index: function(req,res) {
		res.render("index",{ title : "Express with Haxe"});
	}
	,__class__: routes.IndexRoute
}
var $_;
